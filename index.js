...
// ─── CONFIGURATION ────────────────────────────────────────────────────────────
const CHECK_INTERVAL_SECONDS = 240; // Interval in seconds, 19 API keys are needed so that we can check once every 2.16 seconds (the best possible performance without hitting rate limits).
